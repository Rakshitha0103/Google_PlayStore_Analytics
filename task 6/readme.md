...
## Objective
To explore how installs have accumulated over time across different app categories and highlight months with significant growth (> 25% month-over-month), while ensuring category translation and dynamic visibility within a specific time window.
...
![Google Play Store Dashboard](task_google_play_page-0001.png)
...
3. Growth Highlighting – Increased color intensity for months showing > 25% MoM growth.  
4. Visualization – Created a Stacked Area Chart using Plotly Express.  
5. Dynamic Visibility – Chart displayed only between 4 PM and 6 PM IST, hidden outside this range to simulate a real-time dashboard.
...
- Hover tooltips show exact values and category names.  
- Translated legend for international readability.  
- Responsive and interactive layout using Streamlit.
...
## Key Insights
- Categories starting with T or P showed consistent growth in installs.  
- High-rated apps (> 4.2) maintained stronger long-term install trends.  
- Significant monthly growth periods (> 25%) were clearly visualized with color intensity.  
- Multilingual category labels improve accessibility and comprehension.
