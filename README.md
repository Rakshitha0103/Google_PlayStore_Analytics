...
- Interactive **Plotly Choropleth map** for global installs by category.  
- Filters:
...
- Categories: Game, Beauty, Business, Communication  
- Game category highlighted distinctly  
- Same translation logic as Task 4  
...
[Google Play Store Analytics Dashboard](https://appplaystoreanalytics-dyg3q5mrivkktd8ovb9fx6.streamlit.app/)
...
- Dataset is used strictly for learning and analysis purposes
